(function () {
    ...
    window.EASEL_MAP.class.Hex_Layer_Cell = function (i, j, hex_size) {
    ...
    window.EASEL_MAP.class.Hex_Layer_Cell.prototype = {
        ...
        render: function (render_params, container, events) {
            ...
            switch (this.draw_scale(scale)) {
                case 3:
                    ...
                    this.fill_shape = this.fill(container, color, null, scale);
                    break;
                ...
                case 1:
                    this.fill_shape = this.circle_fill(container, color, null, scale);
                    break;
