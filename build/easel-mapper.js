    ...
    function _render(params) {
        ...
        return function (stage, render_params) {
          ...
          var label_layer =  this.label_layer = new createjs.Container();
            ...
            hex_shape.cache(render_params.left, render_params.top, stage.canvas.width /scale, stage.canvas.height/ scale);
            heavy_shape.cache(render_params.left, render_params.top, stage.canvas.width/ scale, stage.canvas.height/ scale);
            axis_shape.cache(render_params.left, render_params.top, stage.canvas.width/ scale, stage.canvas.height/ scale);
            label_layer.cache(render_params.left, render_params.top, stage.canvas.width/ scale, stage.canvas.height/ scale);
